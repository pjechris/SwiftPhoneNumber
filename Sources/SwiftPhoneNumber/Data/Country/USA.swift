...
public extension PhoneCountry {
    /// American Samoa
    static let asm = Self(code: "1", destinations: [.init(areaCodes: 684, length: 10)])

    /// Guam
    static let gum = Self(code: "1", destinations: [.init(areaCodes: 671, length: 10)])
    
    /// Northern Mariana Islands
    static let mnp = Self(code: "1", destinations: [.init(areaCodes: 670, length: 10)])
    
    /// Puerto Rico
    static let pri = Self(code: "1", destinations: [.init(areaCodes: 787, 939, length: 10)])
    
    /// United States
    static let usa = Self(code: "1",
                          destinations: [
